...
/****** Object:  Table [dbo].[AmericanRescuePlan]    Script Date: 8/21/2022 12:58:03 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[AmericanRescuePlan]') AND type in (N'U'))
DROP TABLE [dbo].[AmericanRescuePlan]
GO
