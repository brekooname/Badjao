...
ALTER TABLE [dbo].[Expenditures] DROP CONSTRAINT [DF_Expenditures_Amount]
GO

/****** Object:  Table [dbo].[Expenditures]    Script Date: 8/21/2022 1:17:50 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Expenditures]') AND type in (N'U'))
