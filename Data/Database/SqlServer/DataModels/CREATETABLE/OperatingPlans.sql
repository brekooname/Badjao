...
/****** Object:  Table [dbo].[OperatingPlans]    Script Date: 8/21/2022 1:31:24 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[OperatingPlans]') AND type in (N'U'))
DROP TABLE [dbo].[OperatingPlans]
GO
