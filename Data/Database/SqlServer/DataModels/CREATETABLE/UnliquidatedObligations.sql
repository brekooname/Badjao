...
/****** Object:  Table [dbo].[UnliquidatedObligations]    Script Date: 8/21/2022 1:52:51 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[UnliquidatedObligations]') AND type in (N'U'))
DROP TABLE [dbo].[UnliquidatedObligations]
GO
